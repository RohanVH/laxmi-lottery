...
<div class="row">
	<div class="col-md-4">
		...
		<div class="form-group">
				...
				<input type="text" name="AA" value="<?php echo $AA; ?>" placeholder="AA value" class="form-control input-sm" required>
			</div>

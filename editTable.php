        ...
        <div class='container'>
            ...
            ?>
                    <tr>
                        ...
                        <td> <div style="display:flex;justify-content:center;" contentEditable='true' class='edit' id='time_<?php echo $id; ?>'> <?php echo $time; ?></div> </td>
                        <td> <div style="display:flex;justify-content:center;" contentEditable='true' class='edit' id='status_<?php echo $id; ?>'><?php echo $status; ?> </div> </td>
                    </tr>
            <?php
                    $count ++;
                }
